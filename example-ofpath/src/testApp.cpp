...
//--------------------------------------------------------------
void testApp::genSubjects(ofxSlider<int> & ct) {
    clipSubjects.clear();
...
//--------------------------------------------------------------
void testApp::genMasks(ofxSlider<int> & ct) {
...
//--------------------------------------------------------------
void testApp::genSimplifyPath(ofxSlider<int> &ct) {
